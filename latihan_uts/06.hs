...
getSmallest :: [Int] -> Int
getSmallest mengembalikan elemen terkecil di l dan l tidak kosong.
-}
...
main = 
  do
    print(getSmallest [7,3,9,13,15,31,19])
    print(getSmallest [6,15,4,9])
    print(getSmallest [9,15,27])